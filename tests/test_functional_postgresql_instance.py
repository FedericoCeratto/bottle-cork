...
#
# Unit testing - test the Cork module against a real PostgreSQL instance
...
class TestPostgresUnauth(Conf, testutils.DatabaseInteractionAsUnauthenticated):
    pass


class TestPostgresAdmin(Conf, testutils.DatabaseInteractionAsAdmin):
    pass
