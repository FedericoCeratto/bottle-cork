...
def test_password_hashing_PBKDF2_known_hash(aaa):
    ...
    assert shash == b'cHNzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nzc3Nz9XaEVyNjrXBEKjKHSVWKcjFEaNAAm66rvwCIjDZPru0='

def test_password_hashing_PBKDF2_known_hash_2(aaa):
    assert aaa.preferred_hashing_algorithm == 'PBKDF2sha1'
    salt = b'\0' * HASHLEN
    shash = aaa._hash('user_foo', 'bogus_pwd', salt=salt)
    assert shash == b'cAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAiIL4LIVJ9DCGDQAsAQG7JYvUjm68ZKQqV/TABeWrYzs='
...
def test_password_hashing_PBKDF2_known_hash_3(aaa):
    ...
    salt = b'x' * HASHLEN
    shash = aaa._hash('user_foo', 'bogus_pwd', salt=salt)
    assert shash == b'cHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4uaJQV+rua/emhov7hJ819Sdy6MNGiPfL+e6DbPAeQQU='
